...
<form action="{{ route('recruitment.sendEmail') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row pmclr sushiform opbg p-md-5 p-2">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <a href="" role="button" type="submit" class="sushibtn">SOUMETTRE MA CANDIDATURE</a>
            </div>
