...
<div class="modal fade" id="exampleModalpassword" tabindex="-1" aria-labelledby="exampleModalpassword" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="background-color: #e5d5bf; color: #000;">
        ...
        <div class="row sushiform p-md-3 p-2">
        ...
        <div class="mb-3 d-flex">
            ...
            <input class="blackbrdr" type="password" id="password" name="password" required>
        </div>

        <div class="mb-3 d-flex">
            <label for="password_confirmation">Confirmer le nouveau mot de passe</label>
            <input class="blackbrdr" type="password" id="password_confirmation" name="password_confirmation" required>
        </div>

        <button type="submit" class="btn btn-primary sushibtn" style="color: #000;
    border: 1px solid;">Modifier le mot de passe</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="background-color: #e5d5bf; color: #000;">
        ...
        <div class="input-container" style="display: flex; align-items: center; height: 53px; overflow: hidden;">
          <input type="text" id="map-address-input" name="address" placeholder="Entrez votre adresse...">
