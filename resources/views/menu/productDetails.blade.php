                    ...
                    <div class="col-md-7 p-md-4">
                        ...
                        <div class="row mt-5">
                            <div class="col-6">
                                ...
                                @else
                                <p class="text-center txtmob">{{ $product->composition }}</p>
                                @endif
                                <!-- @php
                        ...
                        @foreach ($compositions as $composition) -->
                            ...
                            <div class="col-6" style="border-left: 1px solid var(--primary-color);">
                                <p class="text-center txtmob">ALLERGENES</p>
                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                ...
                                <p class="text-left txtmob" style="font-size: 0.8rem;">{{ $product->composition }}</p>
                            </div>
                        </div>
                        @endif
                        <div class="row mt-5">
