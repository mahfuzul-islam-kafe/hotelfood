...
Route::get('/summaryPage', 'App\Http\Controllers\CartController@summaryPage')->name('summaryPage');
...
Route::get('/pyament-options-redirect', 'App\Http\Controllers\PaymentController@redirectPaymentMethod')->name('payment-options-redirect')->middleware('auth');
...
Route::post('/recruitment', 'App\Http\Controllers\RecruitmentController@sendEmail')->name('recruitment.sendEmail');
...
Route::prefix('admin')->group(function () {
    Route::get('/', 'App\Http\Controllers\admin\OrderController@index')->name('admin.dashboard');
    ...
    Route::post('/updateOrderStatus', 'App\Http\Controllers\admin\OrderController@updateOrderStatus');
  
});
});
Route::get('/bg-colour' ,function (){
    return view('bg-colour');    
});
